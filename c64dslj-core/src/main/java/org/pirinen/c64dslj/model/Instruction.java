...
public class Instruction {
    ...
    public static final RelativeBuilder<Instruction> BPL = new MultiBuilder(Opcode.BPL);
    public static final RelativeBuilder<Instruction> BMI = new MultiBuilder(Opcode.BMI);
    public static final RelativeBuilder<Instruction> BVC = new MultiBuilder(Opcode.BVC);
    public static final RelativeBuilder<Instruction> BVS = new MultiBuilder(Opcode.BVS);
    public static final RelativeBuilder<Instruction> BCC = new MultiBuilder(Opcode.BCC);
    public static final RelativeBuilder<Instruction> BCS = new MultiBuilder(Opcode.BCS);
    public static final RelativeBuilder<Instruction> BNE = new MultiBuilder(Opcode.BNE);
    public static final RelativeBuilder<Instruction> BEQ = new MultiBuilder(Opcode.BEQ);
    ...
    public static final AbsoluteBuilder<Instruction> JSR = new MultiBuilder(Opcode.JSR);
    public static final Instruction RTS = new MultiBuilder(Opcode.RTS).implied();
    public static final AbsIndBuilder<Instruction> JMP = new MultiBuilder(Opcode.JMP);

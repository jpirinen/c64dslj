...
public class SpriteTest {
	...
	public void testSpriteBuilder() throws IOException {
		Program p = Program.with().d(0x2000, getSprite()).build(0x2000);
	...
	public void testSpriteBuilderWith2Sprites() throws IOException {
		Program p = Program.with().d(0x2000, getSprite())
				.d(0x2040, getSprite()).build(0x2000);
		ByteArrayOutputStream out = new ByteArrayOutputStream();
		p.toCbmFormat(out);
		byte[] data = out.toByteArray();
		Assert.assertEquals(-128, data[2]);
	...
	private static Data getSprite() {
		return monochromeSprite().pixels("X..............X......XX",
				"........................", ".................X......",
				"........................", "........................",
				"........................", "..........XXXX..........",
				".........XXXXXXXX.......", "........XXX....XX.......",

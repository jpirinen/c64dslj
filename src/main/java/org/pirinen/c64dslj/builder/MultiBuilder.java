...
public class MultiBuilder extends InstructionBuilder implements ImmZpZpxIzxIzyAbsAbxAbyBuilder<Instruction>,
    ...
    public Instruction immediate(DataType<Byte> value) {
        return new Instruction(getCommand(Immediate.class), new OneByteOperand(value));
    }
    
    @Override
    public Instruction immediate(int value) {
        return new Instruction(getCommand(Immediate.class), new OneByteOperand(new ByteDec(value)));
    }
    ...
    public Instruction absolute_Y(int value) {
        return new Instruction(getCommand(AbsoluteIndexedY.class), new TwoByteOperand(value));
    }
    ...
    public Instruction absolute_X(int value) {
        return new Instruction(getCommand(AbsoluteIndexedX.class), new TwoByteOperand(value));
    }
    ...
    public Instruction indirectIndexed_Y(DataType<Byte> value) {
        return new Instruction(getCommand(IndirectIndexed.class), new OneByteOperand(value));
    }

    @Override
    public Instruction indexedIndirect_X(DataType<Byte> value) {
        return new Instruction(getCommand(IndexedIndirect.class), new OneByteOperand(value));
    }

    @Override
    public Instruction zeropage_Y(DataType<Byte> value) {
        return new Instruction(getCommand(ZeropageIndexedY.class), new OneByteOperand(value));
    }

    @Override
    public Instruction zeropage_X(DataType<Byte> value) {
        return new Instruction(getCommand(ZeropageIndexedX.class), new OneByteOperand(value));
    }

    @Override
    public Instruction zeropage(DataType<Byte> value) {
        return new Instruction(getCommand(Zeropage.class), new OneByteOperand(value));
    }

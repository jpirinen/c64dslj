...
abstract class FluentMultiBuilder implements
		ImmZpZpxIzxIzyAbsAbxAbyBuilder<FluentBuilder>,
		ImmZpAbsBuilder<FluentBuilder>, ZpZpxAbsAbxBuilder<FluentBuilder>,
		ImpZpZpxAbsAbxBuilder<FluentBuilder>,
		ImmZpZpyAbsAbyBuilder<FluentBuilder>,
	...
	public FluentBuilder indexedIndirect_X(DataType<Byte> value) {
		b.getProgramBuilder().i(
				getIndexedIndirectBuilder().indexedIndirect_X(value));
		return b;
	}
	...
	public FluentBuilder indirectIndexed_Y(DataType<Byte> value) {
		b.getProgramBuilder().i(
				getIndirectedIndexedBuilder().indirectIndexed_Y(value));
		return b;
	}

...
public class Instruction {
    ...
    public static final ImmZpZpxIzxIzyAbsAbxAbyBuilder ORA = new MultiBuilder(Opcode.ORA);
    public static final ImmZpZpxIzxIzyAbsAbxAbyBuilder AND = new MultiBuilder(Opcode.AND);
    public static final ImmZpZpxIzxIzyAbsAbxAbyBuilder EOR = new MultiBuilder(Opcode.EOR);
    public static final ImmZpZpxIzxIzyAbsAbxAbyBuilder ADC = new MultiBuilder(Opcode.ADC);
    public static final ImmZpZpxIzxIzyAbsAbxAbyBuilder SBC = new MultiBuilder(Opcode.SBC);
    public static final ImmZpZpxIzxIzyAbsAbxAbyBuilder CMP = new MultiBuilder(Opcode.CMP);
    public static final ImmZpAbsBuilder CPX = new MultiBuilder(Opcode.CPX);
    public static final ImmZpAbsBuilder CPY = new MultiBuilder(Opcode.CPY);
    public static final ZpZpxAbsAbxBuilder DEC = new MultiBuilder(Opcode.DEC);
    ...
    public static final ZpZpxAbsAbxBuilder INC = new MultiBuilder(Opcode.INC);
    ...
    public static final ImpZpZpxAbsAbxBuilder ASL = new MultiBuilder(Opcode.ASL);
    public static final ImpZpZpxAbsAbxBuilder ROL = new MultiBuilder(Opcode.ROL);
    public static final ImpZpZpxAbsAbxBuilder LSR = new MultiBuilder(Opcode.LSR);
    public static final ImpZpZpxAbsAbxBuilder ROR = new MultiBuilder(Opcode.ROR);
    ...
    // Move instructions
    public static final ImmZpZpxIzxIzyAbsAbxAbyBuilder LDA = new MultiBuilder(Opcode.LDA);
    public static final ZpZpxIzxIzyAbsAbxAbyBuilder STA = new MultiBuilder(Opcode.STA);
    public static final ImmZpZpyAbsAbyBuilder LDX = new MultiBuilder(Opcode.LDX);
    public static final ZpZpyAbsBuilder STX = new MultiBuilder(Opcode.STX);
    public static final ImmZpZpxAbsAbxBuilder LDY = new MultiBuilder(Opcode.LDY);
    public static final ZpZpxAbsBuilder STY = new MultiBuilder(Opcode.STY);
    ...
    public static final RelativeBuilder BPL = new RelativeInstructionBuilder(Opcode.BPL);
    public static final RelativeBuilder BMI = new RelativeInstructionBuilder(Opcode.BMI);
    public static final RelativeBuilder BVC = new RelativeInstructionBuilder(Opcode.BVC);
    public static final RelativeBuilder BVS = new RelativeInstructionBuilder(Opcode.BVS);
    public static final RelativeBuilder BCC = new RelativeInstructionBuilder(Opcode.BCC);
    public static final RelativeBuilder BCS = new RelativeInstructionBuilder(Opcode.BCS);
    public static final RelativeBuilder BNE = new RelativeInstructionBuilder(Opcode.BNE);
    public static final RelativeBuilder BEQ = new RelativeInstructionBuilder(Opcode.BEQ);
    ...
    public static final AbsoluteBuilder JSR = new JsrInstructionBuilder(Opcode.JSR);
    public static final Instruction RTS = new MultiBuilder(Opcode.RTS).implied();
    public static final AbsIndLabelBuilder JMP = new JmpInstructionBuilder(Opcode.JMP);
    public static final ZpAbsBuilder BIT = new MultiBuilder(Opcode.BIT);
